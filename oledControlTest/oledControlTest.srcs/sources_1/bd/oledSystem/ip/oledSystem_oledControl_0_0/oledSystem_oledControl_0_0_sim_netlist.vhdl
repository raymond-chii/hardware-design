...
-- Date        : Thu Nov 16 18:00:32 2023
-- Host        : micro09 running 64-bit Debian GNU/Linux 10 (buster)
-- Command     : write_vhdl -force -mode funcsim
--               /afs/ee.cooper.edu/user/l/lei.chi/oledControlTest/oledControlTest.srcs/sources_1/bd/oledSystem/ip/oledSystem_oledControl_0_0/oledSystem_oledControl_0_0_sim_netlist.vhdl
-- Design      : oledSystem_oledControl_0_0
...
entity oledSystem_oledControl_0_0_charROM is
  port (
  ...
  attribute ORIG_REF_NAME of oledSystem_oledControl_0_0_charROM : entity is "charROM";
end oledSystem_oledControl_0_0_charROM;

architecture STRUCTURE of oledSystem_oledControl_0_0_charROM is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity oledSystem_oledControl_0_0_delayGen is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of oledSystem_oledControl_0_0_delayGen : entity is "delayGen";
end oledSystem_oledControl_0_0_delayGen;

architecture STRUCTURE of oledSystem_oledControl_0_0_delayGen is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity oledSystem_oledControl_0_0_spiControl is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of oledSystem_oledControl_0_0_spiControl : entity is "spiControl";
end oledSystem_oledControl_0_0_spiControl;

architecture STRUCTURE of oledSystem_oledControl_0_0_spiControl is
  ...
  attribute SOFT_HLUTNM of spiLoadData_i_1 : label is "soft_lutpair4";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity oledSystem_oledControl_0_0_oledControl is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of oledSystem_oledControl_0_0_oledControl : entity is "oledControl";
end oledSystem_oledControl_0_0_oledControl;

architecture STRUCTURE of oledSystem_oledControl_0_0_oledControl is
  signal CR_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \byteCounter[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \byteCounter[2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \byteCounter[3]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \byteCounter[3]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \byteCounter[3]_i_5\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \columnAddr[0]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \columnAddr[1]_i_1\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \currPage[0]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \nextState[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \nextState[3]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \nextState[4]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of oled_reset_n_i_2 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of sendDone_i_2 : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \spiData[0]_i_5\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \spiData[2]_i_5\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \spiData[4]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \spiData[4]_i_5\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \spiData[5]_i_5\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \spiData[6]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \spiData[6]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \spiData[6]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \spiData[7]_i_2\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \state[4]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[4]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[4]_i_5\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[4]_i_6\ : label is "soft_lutpair11";
begin
  SR(0) <= \^sr\(0);
  oled_dc_n <= \^oled_dc_n\;
  ...
  oled_vbat <= \^oled_vbat\;
  oled_vdd <= \^oled_vdd\;
CR: entity work.oledSystem_oledControl_0_0_charROM
     port map (
      ...
      \slv_reg2_reg[0]\ => CR_n_53,
      \slv_reg2_reg[0]_0\ => CR_n_54,
      \slv_reg2_reg[1]\ => CR_n_52,
      \slv_reg2_reg[1]_0\ => CR_n_55,
      \slv_reg2_reg[3]\ => CR_n_51,
      \slv_reg2_reg[4]\ => CR_n_49,
      \slv_reg2_reg[5]\ => CR_n_0,
      ...
      \slv_reg2_reg[5]_5\ => CR_n_50
    );
DG: entity work.oledSystem_oledControl_0_0_delayGen
     port map (
      E(0) => state,
...
SC: entity work.oledSystem_oledControl_0_0_spiControl
     port map (
      E(0) => SC_n_4,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity oledSystem_oledControl_0_0_top is
  port (
    s00_axi_aresetn_0 : out STD_LOGIC;
    oled_spi_data : out STD_LOGIC;
    oled_vdd : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of oledSystem_oledControl_0_0_top : entity is "top";
end oledSystem_oledControl_0_0_top;

architecture STRUCTURE of oledSystem_oledControl_0_0_top is
begin
OC: entity work.oledSystem_oledControl_0_0_oledControl
     port map (
      Q(6 downto 0) => Q(6 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity oledSystem_oledControl_0_0_oledControl_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of oledSystem_oledControl_0_0_oledControl_v1_0_S00_AXI : entity is "oledControl_v1_0_S00_AXI";
end oledSystem_oledControl_0_0_oledControl_v1_0_S00_AXI;

architecture STRUCTURE of oledSystem_oledControl_0_0_oledControl_v1_0_S00_AXI is
...
oledTop: entity work.oledSystem_oledControl_0_0_top
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity oledSystem_oledControl_0_0_oledControl_v1_0 is
  port (
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    oled_vdd : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of oledSystem_oledControl_0_0_oledControl_v1_0 : entity is "oledControl_v1_0";
end oledSystem_oledControl_0_0_oledControl_v1_0;

architecture STRUCTURE of oledSystem_oledControl_0_0_oledControl_v1_0 is
begin
oledControl_v1_0_S00_AXI_inst: entity work.oledSystem_oledControl_0_0_oledControl_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity oledSystem_oledControl_0_0 is
  port (
    oled_spi_clk : out STD_LOGIC;
    oled_spi_data : out STD_LOGIC;
    oled_vdd : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of oledSystem_oledControl_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of oledSystem_oledControl_0_0 : entity is "oledSystem_oledControl_0_0,oledControl_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of oledSystem_oledControl_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of oledSystem_oledControl_0_0 : entity is "oledControl_v1_0,Vivado 2019.1";
end oledSystem_oledControl_0_0;

architecture STRUCTURE of oledSystem_oledControl_0_0 is
  signal \<const0>\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of oled_spi_clk : signal is "xilinx.com:signal:clock:1.0 oled_spi_clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of oled_spi_clk : signal is "XIL_INTERFACENAME oled_spi_clk, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN oledSystem_oledControl_0_0_oled_spi_clk, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of s00_axi_aclk : signal is "xilinx.com:signal:clock:1.0 S00_AXI_CLK CLK";
  attribute X_INTERFACE_PARAMETER of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN oledSystem_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
...
inst: entity work.oledSystem_oledControl_0_0_oledControl_v1_0
     port map (
